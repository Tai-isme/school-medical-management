...
const VaccineNotificationModalContent = ({
  ...
  return (
    <div>
      ...
      <p>
        <b>Thông tin về vắc xin:</b>
        <br />
        Tên vắc xin: {notification.vaccineProgram?.vaccineName.vaccineName}
        <br />
        Nhà sản xuất: {notification.vaccineProgram?.vaccineName.manufacture}
        <br />
        <a 
          href={vaccineUrl} 
          target="_blank" 
